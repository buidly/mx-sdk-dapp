...
export const useBuidlyExtensionLogin = ({
  callbackRoute,
  token: tokenToSign,
  nativeAuth,
  onLoginRedirect
  ...
  async function initiateLogin() {
    ...
    setIsLoading(true);
    const provider: BuidlyExtensionProvider = BuidlyExtensionProvider.getInstance();
    ...
    try {
      ...
      dispatch(
        loginAction({ address, loginMethod: LoginMethodsEnum.buidlyExtension })
      );
